#define NGX_CONFIGURE " --with-debug --with-cc-opt='-O0 -g -fsanitize=address' --with-ld-opt=-fsanitize=address --prefix=/home/martin/Projects/split/ws/sandbox --with-http_ssl_module --add-module=/home/martin/Projects/split/ws/sources/proxy_connect/ --add-module=/home/martin/Projects/split/ws/sources/proxy_thru/"
...
#ifndef NGX_COMPILER
#define NGX_COMPILER  "gcc 15.2.1 20250813 (GCC) "
#endif
...
#ifndef NGX_HTTP_PROXY_THRU
#define NGX_HTTP_PROXY_THRU  1
#endif
...
#ifndef NGX_PREFIX
#define NGX_PREFIX  "/home/martin/Projects/split/ws/sandbox/"
#endif
